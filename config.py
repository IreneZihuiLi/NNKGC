...
# /home/irene/Play/HF/bert-base-uncased-own
...
# 202209 we added
parser.add_argument('--if-debug', action='store_true',
                    help='if in a debug model, we save the model after 10 steps.')
parser.add_argument('--model', default='bert', type=str,
                    help='which main model to use, choose from: bert, gcn')
parser.add_argument('--n-neighbor', default=3, type=int,
                    help='how many neighbors we consider')
parser.add_argument('--n-hop-graph', default=1, type=int,
                    help='number of hop with GNN computation')
parser.add_argument('--train-extract-path', default='', type=str, metavar='N',
                    help='path to training data, we extracted json')
parser.add_argument('--freeze-lm', action='store_true',
                    help='If freeze PLM.')
parser.add_argument('--save-every-n-step', default=10000, type=int,
