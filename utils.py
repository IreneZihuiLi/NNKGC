...
def save_checkpoint_debug(state: dict,  filename: str):
    torch.save(state, filename)
    shutil.copyfile(filename, os.path.dirname(filename) + '/model_model_debug.mdl')
...
def delete_old_ckt(path_pattern: str, keep=10):
